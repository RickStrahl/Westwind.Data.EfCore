...
<input type="hidden" name="hosted_button_id" value="GXXXDJDE3UP98" />
<input type="image" src="https://weblog.west-wind.com/images/donation.png" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
